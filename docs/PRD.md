...
- Add basic logging scaffolding using `os.log` with subsystem `llc.fungee.voicebot` and categories: `app`, `download`, `runtime`, `ui`.
...
- Use Apple Unified Logging (`os.log`) with subsystem `llc.fungee.voicebot` and categories:
